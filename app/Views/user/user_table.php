                                ...
                                <td class="text-right">
                                    <div class = "center-container">
                                        <div class="fa-stack action-button">
                                            <a href="<?php echo base_url('UserController/delete/'.$row->id) ?>">
    ...
    <script>
         $(document).ready(function() {
            ...
            $('#add-button').on('click', function() {
                const targetUrl = '<?= base_url("UserController/create") ?>'; // Set the URL you want to call
            ...
            $('.view-button').on('click', function() {
                ...
                const targetUrl = '<?= base_url("UserController/view/") ?>' + sanitizedId; // Construct the URL
                loadContentFromUrl(targetUrl, '#modal-body'); // Call the method with URL and target div
                $('#myModal').show(); // Show the modal
            });
        });
